          ...
          <!-- <form method="post" action="" role="form"> -->
            <div class="row">
              ...
              <div class="col-md-2" style="text-align: right;">
                <button type="submit" class="btn btn-default" style="width: 100%;">Upload</button>
              </div>
            </div>
        ...
        <form method="post" action="" role="form">
          <div class="row" style="align-items: center; border: solid 1px #eee; padding: 5px;">
              ...
              <div class="col-md-1" style="text-align: right; padding: 5px;">
                  <button type="submit" class="btn btn-default" style="width: 100%; margin-bottom: 5px;">Delete</button>
              </div>
          </div>
